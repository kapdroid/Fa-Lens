...
2026-09-09 16:15 · memory · reviewers pass (spec-checker round 2, adr-reviewer). ADR-0015 already proposed in this branch, no new ADR written. Three knowledge notes added (docs/knowledge/toolchain/ajv-and-ajv-formats-are-commonjs-under-nodenext.md, docs/knowledge/harness/tests-and-implementation-land-in-one-commit-red-log-is-the-evidence.md, docs/knowledge/harness/check-allowed-should-always-allow-pnpm-lock-yaml.md), index regenerated. Follow-ups (docs unit for architecture.md §2 + ADR-0001 filename; tighten rule/case schemas; check-allowed always-allow pnpm-lock.yaml) stay in this Progress log, not turned into unit files. PR: https://github.com/kapdroid/Fa-Lens/pull/18
