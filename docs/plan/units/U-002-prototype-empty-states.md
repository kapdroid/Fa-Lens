...
2026-09-09 11:33 · build · gate --fast green at df7fb2e; red.log grep 0 before, grep.log 9 after; nine headless-Chrome screenshots in evidence/U-002/screens (apis.png checked: card title kept, one sentence, one accent button, header primary Run all cases still present, toggle 'Show data' visible)
...
2026-09-09 · memory · lessons recorded: docs/knowledge/design/demo-affordances-in-scenarios-not-header.md, docs/knowledge/harness/headless-chrome-light-and-dark-screenshots.md; no ADR (no decision moved); no follow-up unit drafted (the 234474/mono follow-up is screens.md-owner scope, not a Fa-Lens unit)
